      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-4">
            ...
            <a href="#" className="group px-8 py-4 bg-transparent text-accent font-sans font-bold tracking-wider rounded-none border border-accent flex items-center justify-center gap-3 hover:bg-accent hover:text-background transition-all">
              Download CV
